...
function showPopup(name) {
  ...
  var popup = document.querySelector(".popup-".concat(name));
  var overlay = document.querySelector('.overlay');
  if (!popup) {
    console.error("Popup with class .popup-".concat(name, " not found"));
    return;
  }
  ...
  if (isMobile) {
    ...
    var scrollY = window.scrollY; // Текущая прокрутка страницы
    var popupHeight = popup.offsetHeight;

    // Вычисляем позицию сверху с учетом прокрутки
    var topPosition = Math.max((windowHeight - popupHeight) / 2 + scrollY, scrollY);
    popup.style.position = 'absolute';
    popup.style.left = '50%';
    popup.style.transform = 'translateX(-50%)';
    popup.style.top = "".concat(topPosition, "px");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var menuItems = document.querySelectorAll('.contacts-menu-nav ul li');
  var contentItems = document.querySelectorAll('.contacts-menu-content__item');
  ...
  var swiperProjects = new core(".slider-projects", {
    pagination: {
  ...
  var swiper;
  function initSwiper() {
    var breakpoint = 991; // Укажите нужное разрешение
    var screenWidth = window.innerWidth;
    if (screenWidth > breakpoint) {
      if (!swiper) {
        swiper = new core('.slider-advantges', {
          slidesPerView: 1,
          spaceBetween: 0,
          allowTouchMove: true,
          loop: true,
  ...
  if (contactElements.length > 0) {
    contactElements.forEach(function (contact) {
      var current = contact.querySelector(".contact-current");
      if (current) {
  ...
  document.querySelector('.catalog-menu-item').addEventListener("click", function (event) {
    event.preventDefault();
    document.querySelector('body').classList.toggle('catalog-menu-open');
  });
  document.querySelector('.catalog-menu-close').addEventListener("click", function (event) {
    document.querySelector('body').classList.remove('catalog-menu-open');
  });
  document.querySelector('.overlay').addEventListener("click", function (event) {
    document.querySelector('body').classList.remove('catalog-menu-open');
  });
  document.querySelector('.search-handler').addEventListener("click", function (event) {
    document.querySelector('.header').classList.add('serch-open');
  });
  document.querySelector('.search-form-close').addEventListener("click", function (event) {
  ...
  if (document.querySelector('.video') && window.innerWidth > 991) {
    ...
    document.querySelector('.video .play').addEventListener("click", function (event) {
    ...
    document.querySelector('.video .close').addEventListener("click", function (event) {
      closeVideo();
    });
  ...
  if (document.querySelector('.slider-card-thumbs') && document.querySelector('.slider-card')) {
    var thumbSwiper = new core(".slider-card-thumbs", {
      loop: true,
      spaceBetween: 10,
      slidesPerView: 5,
      freeMode: true,
  ...
  document.addEventListener('click', function (e) {
    var button = e.target.closest('[data-popup]');
    if (button) {
      var popupName = button.getAttribute('data-popup');
      showPopup(popupName);
    }
  });
  if (document.querySelector('.slider-single')) {
    document.querySelectorAll('.slider-single').forEach(function (slider) {
      new core(slider, {
        navigation: {
